...
export default function App({ init, setInit }) {
  ...
  return (
    <>
      ...
      />
      <button className='bg-[#10868a] hover:bg-[#209fa3] text-[#ffffff]  py-2 px-3 rounded inline-flex items-center float-right my-2' onClick={convertHTMLtoPDF}>Download</button>
    </>
  );
}