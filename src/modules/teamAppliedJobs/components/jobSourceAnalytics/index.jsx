    ...
    return (
        <div className='flex flex-row justify-center mt-8'>
            ...
            <div className='flex flex-col bg-slate-100 py-4 rounded-3xl'>
                <div className='flex mx-2 px-2 z-10 -mt-10'>
                    {' '}
                    <Button
                        label='Job Sources'
                        fit
                        fill={!jobType}
                        classes={`md:pr-8 md:pl-6 rounded mx-4 ${jobType && 'border-gray-200'}`}
                    ...
                    <Button
                        ...
                        fit
                        fill={jobType}
                        classes={`md:pr-8 md:pl-6 rounded ${!jobType && 'border-gray-200'}`}
                        onClick={() => setJobTypes(true)}
                    />
                </div>
                <div className='grid lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-2 items-center px-10 -ml-8 mt-4'>
                    {job_sources &&
                        !jobType &&
